...
# Table of contents
0. [My messy server in terms of nginx config](#my-messy-server-in-terms-of-nginx-config)
1. [How to create a systemd service](#how-to-create-a-systemd-service)
2. [How to register a domain name](#how-to-register-a-domain-name)
3. [How to serve via HTTPS](#how-to-serve-via-https)
4. [How to proxy websocket](#how-to-proxy-websocket)
